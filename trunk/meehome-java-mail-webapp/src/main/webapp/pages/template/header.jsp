<nav class="navbar navbar-static-top" role="navigation">
    ...
    <div class="navbar-header">
		...
		<div class="navbar-header">
			<a class="navbar-brand" href="/meehome-java-mail-webapp/accueil.tiles"><span class="glyphicon glyphicon-home"></span></a>
		</div>
    </div>
	...
	<ul class="nav navbar-nav">
        <li class="dropdown">
			...
			<ul class="dropdown-menu">
	            ...
	            <li class="divider"></li>
	            <li><a href="/meehome-java-mail-webapp/destinataires.tiles">Gerer la liste de diffusion</a></li>
